...
class InjectPatternTest < Minitest::Test
  ...
  def test_2
    ...
    # It erate over the bills hash defined above
  ...
  def test_8
    ...
    total_calories = 0
     toppings.each do |topping, num|
       total_calories += (num[:calories] * num[:quantity])
end
